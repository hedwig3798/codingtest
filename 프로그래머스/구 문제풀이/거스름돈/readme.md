...
- - -
### 소감
풀이법을 생각하는데 오랜 시간이 걸렸다.   
완전탐색을 통해서 풀려고 했지만 아무래도 제한사항이 너무 커서 시간복잡도가 어마어마하게 커질것이라 생각하고 다른 방법을 강구하였다.   
dp방식으로 문제를 접근하였고 1~n 금액을 해당 동전으로 만들 수 있는 가짓수를 구하여 문제를 풀었다.   
풀이법을 정하고 나서는 큰 문제 없이 풀 수 있었다.
- - -
