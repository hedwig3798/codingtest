...
<div class="guide-section-description">
      ...
      <div class="markdown solarized-dark"><p>정수로 이루어진 배열 <code>numbers</code>가 있습니다. 배열 의 각 원소들에 대해 자신보다 뒤에 있는 숫자 중에서 자신보다 크면서 가장 가까이 있는 수를 뒷 큰수라고 합니다.<br>
...
- - -
### 소감
upper_bound 와 유사한 알고리즘을 사용하여서 upper_bound 함수를 그대로 가져다 써 보았다.   
하지만 upper_bound 함수는 이분탐색을 이용하는 것을 꺠닫는데 꽤 오랜 시간이 걸려 조금 헤메게 되었다.   
덕분에 엉뚱하게도 문제와는 큰 상관이 없는 upper_bound 함수에 대해 더 많은 공부가 되었다.
- - -
