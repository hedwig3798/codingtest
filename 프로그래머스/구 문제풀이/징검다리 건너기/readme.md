...
- - -
### 소감
알고리즘이 바로 떠오르지 않아 조금 헤메게 되었다.   
아무리 생각해도 부르트 포스 방식으로 풀게되는 경우 시간 복잡도가 너무 높아지는 문제가 발생하였다.   
결국 알고리즘을 찾아 본 결과 슬라이딩 윈도우 알고리즘을 알게 되었고 이 문제에 적용해 보았다.   
덕분에 해당 알고리즘의 원리, 증명, 구현 방법 등을 공부하게 되었고 문제를 풀 수 있게 되었다.
- - -
