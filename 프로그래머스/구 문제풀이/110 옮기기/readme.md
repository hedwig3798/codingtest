...
<div class="guide-section-description">
      ...
      <div class="markdown solarized-dark"><p>0과 1로 이루어진 어떤 문자열 x에 대해서, 당신은 다음과 같은 행동을 통해 x를 최대한 사전 순으로 앞에 오도록 만들고자 합니다.</p>
...
- - -
### 소감
문제를 보고 조금 생각해보니 최대한 0을 앞으로 빼오면 되는 문제임을 알았다.   
처음에는 DP를 사용하여 "110"인 부분을 찾아서 앞으로 끌어왔지만 곧 시간 초과에 걸리게 되었다.   
결국 stack을 활용하여 미리 "110"을 빼고 문자열의 앞에서 연속된 '1'이 나오는 부분을 찾아 제거한 "110"의 갯수 만큼 그 부분에 넣어서 해결하였다.
- - -
