...
<div class="guide-section-description">
      ...
      <div class="markdown solarized-dark"><p>어느 공원 놀이터에는 시소가 하나 설치되어 있습니다. 이 시소는 중심으로부터 2(m), 3(m), 4(m) 거리의 지점에 좌석이 하나씩 있습니다.<br>
...
- - -
### 소감
맵을 활용하여 가능한 모든 경우의 수를 더하면서 주어진 백터를 순회하면 된다.
- - -
