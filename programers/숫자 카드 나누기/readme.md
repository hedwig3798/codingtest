...
<div class="guide-section-description">
      ...
      <div class="markdown solarized-dark"><p>철수와 영희는 선생님으로부터 숫자가 하나씩 적힌 카드들을 절반씩 나눠서 가진 후, 다음 두 조건 중 하나를 만족하는 <u>가장 큰 양의 정수 a</u>의 값을 구하려고 합니다.</p>
...
### 소감
최대공약수를 이용한 문제   
문제에서 가장 큰 약수를 구한다는 구문을 보고 바로 최대공약수로 풀었다.   
그리 어렵진 않았지만, 길이가 1인 경우를 체크해야 한다고 잘못 판단하여 시간이 좀 걸렸다.
- - -
