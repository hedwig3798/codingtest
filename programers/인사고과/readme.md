...
- - -
### 소감
특별한 알고리즘을 이용하여 푸는 것이 아닌 두가지 변수의 비교를 잘 하면 되었다.   
비교 방법을 떠올리는데 조금 헤멨지만, 생각하고 나서는 금방 풀 수 있었다.
- - -
