...
<div class="guide-section-description">
      ...
      <div class="markdown solarized-dark"><p>카카오톡에서는 이모티콘을 무제한으로 사용할 수 있는 이모티콘 플러스 서비스 가입자 수를 늘리려고 합니다.<br>
...
- - -
### 소감
카카오 문제라 특별한 풀이법을 찾으려 하였다.   
하지만 아무리 해도 생각이 나지 않아 일단 dfs를 이용한 완전탐색을 돌려 보았는데 정답이였다.   
다시 생각해보니 완전탐색의 총 연산 횟수가 생각보다 작았다.   
다음부터는 일단 만들어 보고 알고리즘을 생각해 봐야겠다.
- - -
